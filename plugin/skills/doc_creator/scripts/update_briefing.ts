...
// Configuration
const MARKDOWN_FILE = "/home/patricio-santamaria/Projects/flow-forward-with-ai/docs/03_Program_Ops/Strategy/Executive_Briefing_Gemini_Enterprise_Pilot_v1.0.md";
const START_INDEX = 1181; // Start of page 4 briefing (after Table of Contents)
...
function main() {
  ...
  if (!documentId) {
    console.error("Usage: npx tsx update_briefing.ts <documentId>");
    process.exit(1);
  }
  
  try {
    updateDocument(documentId);
    console.log("\n🚀 Briefing document updated successfully via gws CLI!");
  } catch (error) {
